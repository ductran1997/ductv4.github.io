...
const playVideo = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_peerjs__ = __webpack_require__(3);
...
const uid = __webpack_require__(4);
const $ = __webpack_require__(0);
const openStream = __webpack_require__(6);
const playVideo = __webpack_require__(1);
const getIceObject = __webpack_require__(5);


getIceObject(iceConfig => {
    const connectionObj = {
        host: 'stream-20-10.herokuapp.com',
        port: 443,
        secure: true,
        key: 'peerjs',
        config: iceConfig
    };
    // const config = {key : 'tkv5g2acaree9udisdfd'}
    const peer = new __WEBPACK_IMPORTED_MODULE_0_peerjs___default.a(getPeer(), connectionObj);
